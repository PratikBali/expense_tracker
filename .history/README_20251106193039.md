...
A modern, full-stack expense tracking application with React, Redux Toolkit, MongoDB, and Google authentication. Track your expenses in Indian Rupees (₹).
...
- **[ai/README.md](./ai/README.md)** - AI helper tools and troubleshooting 🤖
...
This will:
1. ✅ Auto-detect and configure MongoDB
